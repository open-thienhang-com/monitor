...
func (s *producerStub) Publish(event base.Event, bucket, subset string) error {
...
func Test_NewMultiPublisher(t *testing.T) {
	...
	err := sut.Publish(base.Event{}, "banks", "accounts")
...
func Test_NewMultiPublisher_AggregatesErrors(t *testing.T) {
	...
	aerr := sut.Publish(base.Event{}, "banks", "accounts")
