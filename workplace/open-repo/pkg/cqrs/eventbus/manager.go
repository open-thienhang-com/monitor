...
type MultiPublisher struct {
	publishers []base.EventBus
}

// NewMultiPublisher ...
func NewMultiPublisher(all ...base.EventBus) *MultiPublisher {
...
func (c MultiPublisher) Publish(event base.Event, bucket, subset string) error {
